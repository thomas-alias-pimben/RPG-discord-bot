...
server.on('request', (request, response) => {
    ...
    fs.readFile('test.html', 'utf8' , (err,data) =>{
        ...
        else
        {
            ...
            resultat +=  '<nav class="navbar" role="navigation" aria-label="main navigation"> \n';
            resultat +=  '<div class="navbar-brand"> \n';
            
          
            resultat +=  '  <a role="button" class="navbar-burger" aria-label="menu" aria-expanded="false" data-target="navbarBasicExample"> \n';
                    ...
                    if (att != "id")
                    {
                      if ( att == "attribut")
                      {
                        ...
                        clé.forEach(key => {
                            ...
                            retour += ""+key+" : "+elem[key]+'  &ensp;&ensp;&ensp; <button class="button is-success">+1</button><button class="button is-danger">-1</button><input type="text" id="name" name="name"> '+"<br/>";
